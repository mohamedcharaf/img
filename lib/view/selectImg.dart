          ...
          builder: (controller) {
            return Column(
              ...
              children: [
                  ...
                  CustomeLottieImage(height: 260,path: AppImages.select,),
                  const CustomeTitle(title:"Choose Image",size: 40,),
                  const CustomeBodyText(body:  "You can choose the perscription from your gallery or take an image for it")
                 ,Column(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Button1(buttonIcon: Icons.photo,
                      buttonTitle: "Gallery",imagePath: imagePath,function:() {
                        return controller.afficheImageGallery2(ImageSource.gallery);
                      },),
                    const SizedBox(height: 20,),
                    Button1(buttonIcon: Icons.camera_alt_outlined,
                      buttonTitle: "Camera", function: () async {
                      return  controller.afficheImageGallery2(ImageSource.camera); 
                    },imagePath: imagePath,)
